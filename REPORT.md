...
The MLP was selected because it is sufficient for MNIST and allows clear demonstration of learning behavior and regularization effects.
...
•	Dropout rate: 0.5
•	Weight decay: 0.001
The goal was to maintain consistency and focus on comparing methodologies rather than extensive tuning.
...
•	Only one factor changed at a time
This ensures a fair and reliable comparison.
...
L2 Regularization
The L2 model achieved balanced performance with a smaller gap between training (97.60%) and validation accuracy (97.12%). This demonstrates improved generalization and stable learning behavior.

Early Stopping
The early stopping model achieved high training accuracy (99.01%) but maintained stable validation performance (97.03%). Training was stopped at epoch 6, preventing overfitting and improving efficiency.
